      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 col-xs-3 ">
          <ul class="nav nav-sidebar">
            <li <?php if($catagory === 'Development') echo 'class="active"'; ?> ><a href="set-active-class-and-others-on-community-page-default.php?catagory=Development" >Development</a></li>
            <li <?php if($catagory === 'IT') echo 'class="active"'; ?> ><a href="set-active-class-and-others-on-community-page-default.php?catagory=IT" >IT</a></li>
            <li <?php if($catagory === 'Web') echo 'class="active"'; ?> ><a href="set-active-class-and-others-on-community-page-default.php?catagory=Web">Web</a></li>
            <li <?php if($catagory === 'Business') echo 'class="active"'; ?> ><a href="set-active-class-and-others-on-community-page-default.php?catagory=Business">Business</a></li>
            <li <?php if($catagory === 'Design') echo 'class="active"'; ?> ><a href="set-active-class-and-others-on-community-page-default.php?catagory=Design">Design</a></li>
            <li <?php if($catagory === 'Marketing') echo 'class="active"'; ?> ><a href="set-active-class-and-others-on-community-page-default.php?catagory=Marketing">Marketing</a></li>
            <li <?php if($catagory === 'Photography') echo 'class="active"'; ?> ><a href="set-active-class-and-others-on-community-page-default.php?catagory=Photography">Photography</a></li>
            <li <?php if($catagory === 'Health') echo 'class="active"'; ?> ><a href="set-active-class-and-others-on-community-page-default.php?catagory=Health">Health</a></li>
            <li <?php if($catagory === 'Music') echo 'class="active"'; ?> ><a href="set-active-class-and-others-on-community-page-default.php?catagory=Music">Music</a></li>
            <li <?php if($catagory === 'Language') echo 'class="active"'; ?> ><a href="set-active-class-and-others-on-community-page-default.php?catagory=Language">Language</a></li>
            <li <?php if($catagory === 'Life Style') echo 'class="active"'; ?> ><a href="set-active-class-and-others-on-community-page-default.php?catagory=Life Style">Life Style</a></li>
