    ...
    if(!(isset($_SESSION['valid_email']) && $_SESSION['valid_email'] != ''))
    {
     ...
     include("include/navigationwithoutLogin.php"); 
      ...
      ?>
                  ...
                  <ul class="nav navbar-nav navbar-padding">
                    ...
                    <li class="dropdown active">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li class="active"><a href="after-taken-course-take-you-into-next-level-exam.php">Exam</a></li>
        ...
        <div id="take-you-into-next-level-exam">
            <div class="row special-note">
                <div class="col-sm-2"></div>
                <div class="col-sm-8">
                    <p>This exam is very much important and valuable
                     because the score you will get that will be 
                     added on your personal skill's rating.
                     </p>
                     <p>N.B: This is One Time exam, so be careful.</p>
                </div>
            </div>
            ...
            <?php
                ...
                // for number of question for this final exam

                $query = "SELECT questionID FROM `after_taken_course_final_exam_table` WHERE courseIDInFinalExam = $courseID";
                ...
                {
                    // for quize heading
                    $query = "SELECT heading FROM after_taken_course_final_exam_table WHERE questionID = $questionID";
                    ...
                    // for quize options
                    $query = "SELECT answerList FROM after_taken_course_final_exam_table WHERE questionID = $questionID";
                    ...
                    //$query = "SELECT answer FROM after_taken_course_final_exam_table WHERE questionID = $questionID";
