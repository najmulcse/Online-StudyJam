             ...
             <nav class="navbar navbar-default">
                  <div class="container-fluid">
                    <ul class="nav navbar-nav">
                      ...
                      <li class="active"><a href="course-lecture-page3.html">Curriculum</a></li>
                ...
                <h3>Curriculum</h3> <hr>
                                  <div class="curricl-icon"> 
                                    <h4>Section 1: Web Services and REST Intro</h4><br>
                                    <i class="glyphicon glyphicon-play-circle"> </i>
                                    <h4>Lecture:1</h4><br>
                                    <i class="glyphicon glyphicon-play-circle"> </i>
                                    <h4>Lecture:2</h4><hr>
                                    <h4>Section 2: Web Services and REST Intro</h4><br>
                                    <i class="glyphicon glyphicon-play-circle"> </i>
                                    <h4>Lecture:1</h4><br>
                                    <i class="glyphicon glyphicon-play-circle"> </i>
                                    <h4>Lecture:2</h4><hr>
                                    <h4>Section 3: Web Services and REST Intro</h4><br>
                                    <i class="glyphicon glyphicon-play-circle"> </i>
                                    <h4>Lecture:1</h4><br>
                                    <i class="glyphicon glyphicon-play-circle"> </i>
                                    <h4>Lecture:2</h4><hr>
