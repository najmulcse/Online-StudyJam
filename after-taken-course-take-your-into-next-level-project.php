    ...
    if(!(isset($_SESSION['valid_email']) && $_SESSION['valid_email'] != ''))
    {
     ...
     include("include/navigationwithoutLogin.php"); 
      ...
      ?>
                  ...
                  <ul class="nav navbar-nav navbar-padding">
                    ...
                    <li class="dropdown active">
                      ...
                      <ul class="dropdown-menu">
                        <li class="active"><a href="after-taken-course-take-your-into-next-level-project.php">Project</a></li>
        ...
        <div id="take-you-into-next-level-project">
         ...
         <?php
            ...
            $query = "SELECT projectID FROM `after_taken_course_project_table` WHERE courseIDInProject = $courseID";

            $result = mysqli_query($con,$query);

            $row = mysqli_fetch_assoc($result);

            $projectContentNumber = mysqli_num_rows($result);

            $projectID = $row['projectID'];
        
        
            for($i = 1; $i <= $projectContentNumber; $i++)
            {
                // for project heading
                $query = "SELECT projectHeading FROM `after_taken_course_project_table` WHERE projectID = $projectID";
                ...
                $query = "SELECT projectDescription FROM `after_taken_course_project_table` WHERE projectID = $projectID";
                ...
                // for project file URL
                $query = "SELECT fileURL FROM `after_taken_course_project_table` WHERE projectID = $projectID";
                ...
                // for project userName
                $query = "SELECT student_info.F_NAME, student_info.L_NAME FROM student_info,after_taken_course_project_table WHERE student_info.EMAIL = after_taken_course_project_table.emailInProject AND projectID = $projectID";
                ...
                <div class="col-sm-6">
                    <form>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="project-title" placeholder="Project title">
                        </div>
                        
                        <div class="form-group">
                            <label for="project-description">Description :</label>
                            <textarea rows="6" cols="91"></textarea>
                        </div>
                        
                        
                        <div class="form-group">
                            <label for="project-upload">Upload Project :</label>
                            <input type="file"  id="project-upload" placeholder="Project Upload">
                        </div>
                        
                        <div class="row">
                            <div class="col-sm-9"></div>
                            <div class="col-sm-3">
                                <button type="submit" class="btn btn-success">Upload your project</button>
                            </div>
                        </div>
