                     ...
                     <div class="row">
                            ...
                            <div class="col-sm-9 col-md-9">
                             ...
                             <div class="col-sm-7 col-md-7">
                                       <br><br>
                                     <form action="message-send.php" method="post" class="form-horizontal" role="form">
                                        
                                        
                                         <?php
                                         $query_individual="SELECT * FROM all_message WHERE SN='$ID' AND SENT='$email_receive'";
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                             <label class="control-label col-sm-2 col-xs-2 col-md-2" for="to-send">To</label>
                                             <div class="col-sm-10 ">
                                                 <label for="to-message-send" class="col-sm-6 "><?php 
                                         ...
                                         <div class="form-group">
                                              <label class="control-label col-sm-2 col-xs-2" for="title">Title</label>
                                              <div class="col-sm-10 ">
                                                 <label for="messg-title" class="col-sm-6 "><?php echo $title; ?></label>
                                             </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                 ...
                                                 <textarea class="form-control textSizeing" rows="8" cols="75" id="message" name="show-message"  readonly><?php  echo $message; ?></textarea>
                                             </div>
                             ...
                             <div class="col-sm-5 col-md-5">
                              <ul class="dropdown">
                                               <li><a href="message-new.php?id=send &title=1 &email= &message=2">New Message</a>
                                                <li style=""><a href="#">Inbox</a>
                                                    <ul class="sub_menu">
                                                        <?php 
