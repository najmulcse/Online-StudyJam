...
<body>
	...
	<div class="fluid-container">
        ...
        <!-- 1st navbar
        ===================== -->
	   <?php include("include/navigationwithoutLogin.php"); ?>
        <!-- vedio section
        ===================== -->
                  ...
                  <ul class="nav navbar-nav navbar-padding">
                    ...
                    <li class="dropdown active">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li class="active"><a href="after-taken-course-take-you-into-next-level-real-life-application.php">Real life Application</a></li>
        ...
        <div id="take-you-into-next-level-real-life-application">
            
            <?php
            
                // for  description
                $query = "SELECT description FROM `after_taken_course_real_life_application_table` WHERE course_ID = $courseID";
                ...
                // for videoURL
                $query = "SELECT vedioURL FROM `after_taken_course_real_life_application_table` WHERE course_ID =  $courseID";

                $result = mysqli_query($con,$query);

                $row = mysqli_fetch_assoc($result);
 
                $vedioURL = $row['vedioURL']; 
            
                $pieces = explode("\\", $vedioURL);
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <h3>This is where you can apply your knowledge from this course</h3>
                        <p>'.$description.'</p><br>
                        ...
                        <div class="col-sm-8">
                            ...
                            <!--<iframe width="560" height="315" src="https://www.youtube.com/embed/_PAdDhO3efw?list=RDLg0CMJntlGA" frameborder="0" allowfullscreen></iframe>-->
                    </div>
                        </div>
                </div><br><br><br>';
